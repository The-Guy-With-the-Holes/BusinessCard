...
let wrapper=createElement('div',{id:'IconBox',className:'box-grid'})//,innerHTML:content});
    ...
    if (Socials.settings.branding===true){
        let container = createElement('p',{id:'Bloodworks',innerHTML:`<p style="text-align:right; margin-right:min(2vw,16px)">Powered by <a href="http://www.bloodweb.net">Bloodweb.net<img src="./BloodW.png"></img></a></p>`
        });    
